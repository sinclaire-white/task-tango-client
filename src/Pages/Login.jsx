...
<h2 className="mb-5 text-5xl font-semibold text-center">Login Here</h2>
        ...
        <p>Haven't registered yet? <NavLink to={"/signup"} className={"underline"}>Sign Up Now</NavLink></p>
      </fieldset>
     </form>
